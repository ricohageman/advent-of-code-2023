...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `72.1µs` | `863.2µs` |
| [Day 2](./src/bin/02.rs) | `38.6µs` | `49.0µs` |
| [Day 3](./src/bin/03.rs) | `234.0µs` | `246.7µs` |
| [Day 4](./src/bin/04.rs) | `198.6µs` | `194.1µs` |
| [Day 5](./src/bin/05.rs) | `21.6µs` | `74.1µs` |
| [Day 6](./src/bin/06.rs) | `633.0ns` | `491.0ns` |
| [Day 7](./src/bin/07.rs) | `295.2µs` | `287.0µs` |
| [Day 8](./src/bin/08.rs) | `150.2µs` | `494.8µs` |
| [Day 9](./src/bin/09.rs) | `171.2µs` | `165.9µs` |
| [Day 10](./src/bin/10.rs) | `254.7µs` | `258.3µs` |
| [Day 11](./src/bin/11.rs) | `503.5µs` | `491.2µs` |
| [Day 14](./src/bin/14.rs) | `354.9µs` | `167.8ms` |
| [Day 15](./src/bin/15.rs) | `55.2µs` | `272.0µs` |
